...
Revision ID: 062c088691ac
Revises: 
Create Date: 2022-07-25 22:35:13.326044
...
def upgrade() -> None:
    ...
    default_types = ("Товар", "Услуги", "Недвижимость")

    default_tags = (("Товар", "Мебель"),
                    ("Товар", "Электроника"),
                    ("Товар", "Одежда"),
                    ("Услуги", "Ремонт"),
                    ("Услуги", "Уборка"),
    ...
    tag_types = [
        TagCategory(category=category_name) for category_name in default_types
    ]
