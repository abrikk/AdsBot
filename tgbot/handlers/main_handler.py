...
async def get_statistics_text(dialog_manager: DialogManager, **_kwargs):
    ...
    text = (f"📊 Статистика бота\n\n"
            ...
            f"🟠 Всего объявлений с рубрикой «Продам» ({count_ads and round((count_ads_sell/count_ads), 2)*100 or 0}%): {hcode(count_ads_sell)}\n"
            f"🔴 Всего объявлений с рубрикой «Куплю» ({count_ads and round((count_ads_buy/count_ads), 2)*100 or 0}%): {hcode(count_ads_buy)}\n"
            f"🟡 Всего объявлений с рубрикой «Сдам» ({count_ads and round((count_ads_rent/count_ads), 2)*100 or 0}%): {hcode(count_ads_rent)}\n"
            f"🟢 Всего объявлений с рубрикой «Сниму» ({count_ads and round((count_ads_occupy/count_ads), 2)*100 or 0}%): {hcode(count_ads_occupy)}\n"
            f"🔃 Всего объявлений с рубрикой «Обменяю» ({count_ads and round((count_ads_exchange/count_ads), 2)*100 or 0}%): {hcode(count_ads_exchange)}")
